...
The chart below demonstrates the amount of total drivers, total rides, total fares, and average fares per ride and driver for each city type. As you can see the average fare per driver for rural cities is much higher compared to suburban and urban locations. These prices could correlate with the amount of total drivers available which was only 78, thus a higher fee is charged. Alternatively, in urban cities the amount of total drivers was 1,625 and the average fare per driver was only $16.57. 
